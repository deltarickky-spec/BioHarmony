/**
 * BioHarmony Analytics — central pricing source of truth (frontend).
 * Mirrored at artifacts/api-server/src/pricing.ts.
 *
...
// ─── Bundles (true savings over a la carte) ──────────────────────────────────
...
// ─── Practitioner Plans (NO scan limits — per Rick) ─────────────────────────
...
const LEGACY_PLAN_ALIASES: Record<string, string> = {
  ...
  "quick-wellness": "vitals",        // was redundant
  "emotional-balance": "inner-voice", // was redundant
  "body-system-focus": "body-system", // was redundant
  "complete-wellness": "comprehensive", // was redundant
};

/** All plans flattened for lookup. */
...
export function getPlanLabelWithPrice(id: string | null | undefined): string {
  const p = getPlan(id);
...
export const PRICING_DISCLAIMER =
  "AO Scan is an educational wellness tool, not a medical device. Not intended to diagnose, treat, cure, or prevent any condition.";
