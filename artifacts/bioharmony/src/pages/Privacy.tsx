      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-[#F4EFE6]/70 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">When you use Bio-Frequency Analytics, we collect information you provide directly to us, including:</p>
          ...
          <section>
            ...
            Bio-Frequency Analytics — <a href="mailto:contact@bioharmonysolutions.com" className="text-[#BFA14A] hover:underline">contact@bioharmonysolutions.com</a></p>
          </section>

        </div>

        <div className="mt-16 pt-8 border-t border-white/8 text-xs text-[#F4EFE6]/25 leading-relaxed">
          Bio-Frequency Analytics is committed to protecting your privacy and handling your data with care and transparency.
        </div>
      </div>
    </div>
  );
