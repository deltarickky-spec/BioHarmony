      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-[#F4EFE6]/70 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing or using any service provided by Bio-Frequency Analytics ("we," "us," or "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.</p>
          </section>

          <section>
            <h2 className="font-serif text-xl text-[#F4EFE6]/90 mb-3">2. Nature of Services</h2>
            <p className="mb-3">Bio-Frequency Analytics provides frequency-based wellness education, bio-frequency scan analysis, and personalized wellness reports. All services are intended for <strong className="text-[#F4EFE6]/85">educational and informational purposes only</strong>.</p>
            <p>Our services are not medical devices, and our reports do not constitute medical diagnoses, treatment plans, or medical advice of any kind. Bio-Frequency Analytics is a wellness education platform, not a healthcare provider.</p>
          </section>
          ...
          <section>
            ...
            <p>Never disregard professional medical advice or delay seeking it because of something you have read or received through Bio-Frequency Analytics.</p>
          </section>
          ...
          <section>
            ...
            <p>All content on this platform — including reports, audio files, educational materials, and brand assets — is the intellectual property of Bio-Frequency Analytics. Reports are licensed for personal use only and may not be redistributed commercially.</p>
          </section>

          <section>
            <h2 className="font-serif text-xl text-[#F4EFE6]/90 mb-3">7. Limitation of Liability</h2>
            <p>To the maximum extent permitted by law, Bio-Frequency Analytics shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services. Our total liability shall not exceed the amount paid for the specific service in question.</p>
          </section>
        ...
        <div className="mt-16 pt-8 border-t border-white/8 text-xs text-[#F4EFE6]/25 leading-relaxed">
          Bio-Frequency Analytics services are for wellness education and informational purposes only. These services are not intended to diagnose, treat, cure, or prevent any disease or medical condition.
        </div>
      </div>
    </div>
  );
